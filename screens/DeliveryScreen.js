...
const DeliveryScreen = () => {
  ...
  return (
    <View className='bg-[#00CCBB] flex-1'>
      <SafeAreaView className='z-50'>
        ...
        <View className='bg-white mx-5 my-2 rounded-md p-6 z-50 shadow-md'>
            <View>
                ...
                <Text className='text-4xl font-bold'>20-25 Minutes</Text>
            </View>
            <Progress.Bar size={30} color='#00CCBB' indeterminate={true} className='mt-3' />
      ...
      <SafeAreaView className='bg-white flew-row items-center space-x-5 h-28'>
       
          <View className='flex flex-row gap-10 items-center'>
            <Text className='text-gray-400'>Your Driver</Text>
            <Text className='text-lg'>Tadas Mohammed</Text>
          </View>
      </SafeAreaView>
    </View>
  )
